...
const routes: Routes = [
  ...
  { path: "add-saint", component: AddStudentComponent },
  { path: "mark-register", component: AddDepartmentComponent },
  { path: "add-asserts", component: AddCouseComponent },
  { path: "add-subject", component: AddSubjectComponent },
  { path: "saints-list", component: StudentListComponent },
  { path: "register", component: AllDepartementComponent },
  { path: "all-lectures", component: AllAddLecturesComponent },
  { path: "asserts", component: AllCoursesComponent },
